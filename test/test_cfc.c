...
void test_cfc_tau_per_element_valid(void) {
    printf("\n=== CfC Per-Element Tau (all valid) ===\n");
    ...
    yinsen_cfc_cell(x, h_prev, 0.1f, &params, h_new);
...
void test_cfc_tau_per_element_some_invalid(void) {
    printf("\n=== CfC Per-Element Tau (some invalid) ===\n");
...
void test_cfc_tau_per_element_all_invalid(void) {
    printf("\n=== CfC Per-Element Tau (all invalid) ===\n");
...
int main(void) {
    ...
    test_cfc_tau_per_element_valid();
    test_cfc_tau_per_element_some_invalid();
    test_cfc_tau_per_element_all_invalid();
